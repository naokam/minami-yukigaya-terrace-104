...
(function () {
  ...
  const themeCopy = {
    default: {
      title: '南雪谷テラス１０４',
      subtitle: '感性が宿る、デザイナーズメゾネット',
      lead: 'ロンドン王立芸術大学院で学んだオーナーが<br>細部までこだわり抜いた唯一無二の住空間'
    },
    warm: {
      title: '南雪谷テラス 104',
  ...
  const CATEGORIES = ['リビング', 'キッチン', '寝室', '和室', '水回り', 'バルコニー', '外観'];
  ...
  const CAPTION_TEMPLATES = {
    ...
    'バルコニー': ['プライベートテラス', 'テラスの緑', 'バルコニーからの眺め', '屋外空間'],
